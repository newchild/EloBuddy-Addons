...
namespace WindowsMessages
{
    public static class WindowsMessages
	{
		...
		public delegate void KeyDown(VirtualKey key, bool FirstMessage, int RepeatCount);
		public static event KeyDown OnKeyDown;

		public delegate void KeyUp(VirtualKey key);
		public static event KeyUp OnKeyUp;

		public delegate void MouseMove(Vector2 MousePos);
		public static event MouseMove OnMoveMouse;
		...
		private static void Game_OnWndProc(WndEventArgs args)
		{
			...
			{
				case 0x101:
					OnKeyUp((VirtualKey)args.WParam);
					break;
				case 0x100:
					OnKeyDown((VirtualKey)args.WParam, ((args.LParam & 0x40000000) != 1), args.LParam & 0xffff);
					break;
				case 0x200:
					Vector2 MousePos = new Vector2(args.LParam & 0xffff, args.LParam >> 16);
					OnMoveMouse(MousePos);
					break;
			}
		}
	}
